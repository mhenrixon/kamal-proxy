...
3. Start the proxy.
4. Verify: `kamal-proxy domains list` and the certificate expiry metrics
   should show the restored estate; handshakes for restored domains serve
   immediately, with no new ACME orders.
